...
function Strategy(options, verify) {
  ...
  options.authorizationURL =
    options.authorizationURL ||
    "https://auth.youngstargram.com/oauth2/authorize";
  options.tokenURL =
    options.tokenURL || "https://auth.youngstargram.com/oauth2/token";

  OAuth2Strategy.call(this, options, verify);
  this.name = "youngstargram";

  this._profileURL =
    options.profileURL || "https://openapi.youngstargram.com/oauth2/profile";
}
...
Strategy.prototype.userProfile = function(accessToken, done) {
  this._oauth2.useAuthorizationHeaderforGET(use);
